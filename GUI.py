...
method = "min_max_3_turns_horizon_safe"
...
class GUI:
    ...
    def simulate_game(self, click_event=None):
        # valid methods: random, weakest, terrible_player, min_max_2_turns, min_max_3_turns, min_max_3_turns_horizon_safe, min_max_3_turns_horizon_safe_ab
        method = {True: "min_max_3_turns_horizon_safe_ab", False: "min_max_2_turns"}[self.game.board.turn]
    ...
    def click(self, event):
        ...
        if (row, col) == self.selected_piece:   # deselect the current piece
            ...
            if row in [0, 7] and self.game.board.piece_at(coordinates_to_square(self.selected_piece[0], self.selected_piece[1])):
                promotion = chess.QUEEN
            else:
                promotion = None

            self.game.board.push(
                chess.Move(from_square=coordinates_to_square(self.selected_piece[0], self.selected_piece[1]),
